...
def image_block_hash(image_pixel_vector, block_num=16):
...
if __name__ == '__main__':
    ...
    # Load data
    data = mnist_data()
    # x=image_block_hash(noise(784,1))
    ...
    original_image =  image_block_hash(original_image)
    ...
    for epoch in range(num_epochs):
        ...
        # 2. Train Generator
        Z_orig = noise(BATCH_SIZE, NOISE_SIZE)
